      ...
      <section className="py-8 md:py-16">
        <div className="container-custom">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {brandProducts.map(product => <a key={product.id} href={product.link} target="_blank" rel="noopener noreferrer" className="block">
                <Card className="overflow-hidden h-full hover:opacity-90 transition-opacity duration-300 rounded-lg">
                  <div className="aspect-square overflow-hidden">
                    <img src={product.img} alt={product.title} className="w-full h-full object-cover" onError={e => {
