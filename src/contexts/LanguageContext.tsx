...
const translations = {
  en: {
    ...
    abuDhabi: "Abu Dhabi",
    sharjah: "Sharjah",
    dubaiDesc: "Experience the luxurious city of skyscrapers and beautiful beaches",
    abuDhabiDesc: "Explore the cultural capital of UAE, rich in heritage",
    sharjahDesc: "Enjoy the cultural heritage and art in the cultural capital of UAE",
    joinTour: "Join Tour - FREE",
    noBooking: "NO BOOKING REQUIRED",
    joinFreeTrip: "Join Your FREE Trip Now! NO BOOKING REQUIRED",
  ...
  ar: {
    ...
    ourMission: "مهمتنا",
    missionText1: "في GCLX للتجارة العامة، مهمتنا ��ي سد الفجوة بين العلامات التجارية العالمية المتميزة والمتسوقين المحليين من خلال توفير منتجات أصلية بخصومات لا تقبل المنافسة. نحن نستفيد من علاقاتنا القوية مع الموردين وقدرات التوريد بكميات كبيرة لجعل الرفاهية والجودة في متناول الجميع.",
    missionText2: "نحن نؤمن بأن الجميع يستحق ��لوصول إلى منتجات عالية الجودة من أفضل العلامات التجارية في العالم دون دفع هوامش تجزئة باهظة. من خلال برنامج القسائم الحصري ونموذج التوصيل المباشر للمستهلك، نحن قادرون على تمرير وفورات كبيرة من 20-50% لعملائنا الكرام.",
    ourPromise: "وعدنا",
    ...
    retailExperienceDesc1: "كبائع تجزئة متعدد العلامات التجارية، تقدم GCLX للعملاء راحة التسوق للمنتجات من عشرات العلامات التجارية العالمية المتميزة في مكان واحد. تمتد مجموعاتنا المختارة بعناية لتشمل أزياء الرجال والنساء والإكسسوارات ومنتجات التج��يل والأدوات المنزلية.",
    ...
    couponProgramShort: "وفر 20-50% ��ع نظام الخصم الفريد الخاص بنا",
    ...
    abuDhabi: "أبو ظبي",
    sharjah: "الشارقة",
    dubaiDesc: "اكتشف روعة دبي، مدينة السحاب والشواطئ الرائعة",
    abuDhabiDesc: "استكشف عاصمة الإمارات الثقافية الغنية بالتراث",
